...
from asm_to_bin import Instruction, F32IS_Writer
...
if __name__ == "__main__":
    instrucciones = parse_assembly_file("./fcc/input/prueba_asm1.asm")
    ...
    F32IS_Writer.save_bin("./fcc/output/with_parser.bin", encoded_instructions)
    F32IS_Writer.save_hex("./fcc/output/with_parser.hex", encoded_instructions)
